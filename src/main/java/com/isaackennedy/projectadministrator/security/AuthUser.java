package com.isaackennedy.projectadministrator.security;
...
public class AuthUser implements UserDetails {
    ...
    public AuthUser(Long id, String email, String senha, Set<TipoUsuario> tipos) {
        super();
        this.id = id;
        this.email = email;
        this.senha = senha;
        this.authorities = tipos.stream().map(x ->
